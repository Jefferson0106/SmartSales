 			...
 			<div class="row align-items-center">
 				<div class="col-lg-6 col-md-12 col-sm-12">
                    ...
                    <div class="image-one wow fadeInUp" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                        <img class="imagen-telefono" src="/assets/resourcomp/9560814sized.png" alt="">
                    </div>                        
 				...
 				<div class="col-lg-6 col-md-12 col-sm-12">
 					<div class="info-content-area">
 						<div class="section-title">
 							<!---h6>About Us</h6> --->
 							<h2 class="h2-titulo-smarmar-punto"><span class="punto"></span>Interacción automática<b></b></h2>
 						</div>
